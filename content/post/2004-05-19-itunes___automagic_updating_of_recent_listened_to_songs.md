...
excerpt: recently apple released a pretty good COM sdk for its itunes program. my
  ...
  my own v...
summary: apple dropped a cool COM sdk for itunes, and my buddy ajc made some sample
  code to post your currently playing song online. i tried it out and now you can
  see my last 5 songs right below the del.ico.us links. next up, i wanna make a flash
  app for myspace and eventually a slick little taskbar app. also, this is my first
  dive into c# and i'm really diggin' it!
tags:
- programming
- myspace
- C#
