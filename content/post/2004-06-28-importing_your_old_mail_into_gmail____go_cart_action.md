...
summary: imported my old email into gmail during lunch using this cool tool by mark
  lyon. it's a bit slow, but i'm chill with that. also, twisted sister's 'burn in
  hell' is on repeat today.
tags:
- email import
- server
- humor
