...
summary: after using itunes for a day, the author reflects on the differences between
  software in the pc and mac worlds, noting how mac's focused design contrasts with
  the diverse competition in pc software. while initial backlash about itunes's features
  existed, overall sentiments seem to shift positively as itunes competes in the pc
  market.
tags:
- windows
- war
