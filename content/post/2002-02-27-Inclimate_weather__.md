...
summary: the blog post talks about how a friend used to describe relationships as
  weather, a canceled breakdancing event, and a fun phone call with a new friend.
  it also touches on frustrations with biased media and the addition of a new hobby
  from a comic.
tags:
- phone
- media bias
