...
summary: "microsoft is looking to take charge of the national ID initiative with its\
  \ .NET passport system, planning to give everyone a passport while using an insecure\
  \ protocol. the u.s. is considering this tech, and opinions are mixed\u2014some\
  \ find it cool in a shadowrun sort of way, while others are skeptical."
tags:
- national ID
- source
- technology
