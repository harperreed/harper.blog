...
summary: the blog post discusses the absurdity of the US bombing civilian targets
  in afghanistan, highlighting the media's one-sided narrative and the government's
  justifications for such actions. it draws parallels between military actions and
  law enforcement decisions, emphasizing a critique of the war on terror.
tags:
- war
- wedding
