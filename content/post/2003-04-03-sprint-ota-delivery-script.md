---
date: 2003-04-03 11:04:43+00:00
summary: this post introduces a php script that can be easily installed in any directory
  to serve content to phones without needing to tweak server settings. it's free to
  use and is in beta, with a link for feedback and download options.
tags:
- screensavers
- ringtones
- open source
