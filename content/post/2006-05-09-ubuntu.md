...
summary: trying out pyramid linux on ubuntu while compiling for a soekris box. running
  into some issues with pcmcia support and apt-get needing a cdrom. found a fix by
  editing sources.list. more updates later!
tags:
- general
