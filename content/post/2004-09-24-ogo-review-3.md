...
summary: i got my OGO in the mail and it's pretty cool! it does IM, email, and text
  all in one. it's a bit bigger than a sidekick when opened, but feels good in the
  hand. the screen is bright and the keys are nice to type on. it's missing a web
  browser and has some annoying sounds, but overall it seems like a solid device for
  chatting.
tags:
- review
- general
