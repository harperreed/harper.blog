...
description: 라이카 카메라를 소유하고 사용하는 데 관한 형편없는 조언 몇 가지. 또한 일반적인 사진 조언도 포함되어 있습니다.
draft: false
...
- photography-tips
- cameras
title: '라이카를 찍는 초보처럼 라이카를 다루는 법

  description: 라이카 카메라를 소유하고 사용하는 데 관한 형편없는 조언 몇 가지. 또한 일반적인 사진 조언도 포함되어 있습니다.'
translationKey: How to Leica like a noob who shoots Leica
---

지난 몇 년 동안 _라이카 극단주의의 길_을 걷다 보니 메모해 두고 싶은 생각이 쌓였다. 원래는 오리지널 Q(이른바 OG Q)와 M11을 막 장만한 친구 몇 명에게만 보내려던 글인데, 다른 사람들에게도 도움이 될 것 같아 이렇게 공유한다. 사람마다 다를 수 있으니 가볍게 참고만 해(YMMV).

{{< image src="/images/posts/photos-congee.jpg" caption="Congee spot in Guangzhou. Leica Q. 2016">}}

2016년에 오리지널 Q(OG Q)를 들인 뒤로 줄곧 라이카만 써 왔다. 그동안 [Q](https://en.wikipedia.org/wiki/Leica_Q_), [오리지널 모노크롬(OG Monochrom)](https://en.wikipedia.org/wiki/Leica_M_Monochrom) ― 내 인생 최고의 카메라 ―, [262](https://en.wikipedia.org/wiki/Leica_M_(Typ_262))를 거쳤고(10 BTC 주고 샀다, ㅎㅎ), 지금은 [M11](https://en.wikipedia.org/wiki/Leica_M11)로 찍고 있다. 장비도 좋고, 커뮤니티도 좋고, 라이카 특유의 분위기가 마음에 든다.

누군가 라이카는 남자들의 [버킨백](https://en.wikipedia.org/wiki/Birkin_bag)이라고 하더라. 틀린 말은 아니다. 나쁘다는 건 아니고 그냥 웃길 뿐이다.
...
- 줌 렌즈는 웬만하면 필요 없다. 친구 [Trammell](https://twitter.com/trammell)의 말처럼 “발로 줌해라(Zoom with your feet)”, 직접 다가가서 찍으면 된다.  
- 동네 [사진 교실이나 커뮤니티](https://www.latitudechicago.org/education)에서 수업을 여러 개 들어 봐. 쉬울 것 같아도 가 보면 배울 게 많고 친구도 생긴다.  
  - 나는 조명 수업을 듣고 완전히 눈이 트였다.  
- [지역 인화소](https://www.latitudechicago.org/printing-services)에서 프린트해 봐. 재미도 있고 많이 배운다.  
...
- 내가 좋아하는 사진 철칙: **변수를 줄이면 결과가 좋아진다.**  
  ...
  - 조리개를 f/8에 고정해 둬.  
  - 인생의 다른 일도 마찬가지다.  
- 찍은 [사진](https://harper.photos)을 공유해!
...
- 내 단골은 시카고의 [Tamarkin Camera](https://www.tamarkin.com/)다. 믿음직하고 친절하다. Dan에게 “Harper가 보냈다”고 전해.  
- 온라인 쇼핑이라면 [Leica Miami](https://leicastoremiami.com/)도 괜찮다.  
- 아마존은 조심해. [짝퉁이 많다](https://www.techdirt.com/2018/01/17/homeland-securitys-over-obsession-with-counterfeits-now-harming-innocent-buyers-counterfeit-goods-online/).  
...
- 렌즈만도 수도 없이 갈아봤다. 결국 [50 mm 써미룩스(Summilux)](https://en.wikipedia.org/wiki/Summilux) 하나로 정착했다. 50 mm 화각, 느낌, 프레이밍이 딱 좋다.  
- 여행할 때 렌즈를 두 개 이상 가져가 본 적이 없다.  
- 처음부터 초점 심도가 말도 안 되게 얕은 ‘광속’ 렌즈로 배우면 맞히는 컷이 5% 정도라 멘붕 온다. 시작은 빈티지 써미크론(Summicron) 같은 비교적 느린 렌즈로 해. 재미도 있고 성공률도 높다. _그다음_ 에 값도 미치도록 비싼, F값 낮은 렌즈로 넘어가면 돼.  
- 전용 카메라 가방은 거의 안 쓴다. 파우치에 넣어 토트백이나 백팩에 바로 넣는다. 빨리 꺼낼 수 있어야 하거든.  
  - [Artisan & Artist](https://aaa-tokyo.com) 제품을 좋아한다.  
    - [ACAM-75](https://aaa-tokyo.com/camera/camera-pouch/acam-75/)라는 작은 파우치를 카메라 ‘포장지’처럼 쓴다.  
- 손에 맞는 스트랩을 찾아라.  
  - 나는 ‘빈티지’ Leica Goodies 슬링 스트랩을 쓴다.  
  - 친구들은 [Cooph](https://store.cooph.com/en-us)을 좋아한다.  
  - [Artisan & Artist](https://aaa-tokyo.com) 스트랩도 좋다.  
  - Peak Design 스트랩은 기능이 지나치게 많아서 내 취향은 아니다.  
- 가죽 하프 케이스는 보기에도 좋고 실용적이다.  
- 나는 한국 브랜드 [Arti di Mano](https://artedimano.com/Leicacases/?idx=291)를 쓴다. 색상도 다양하고, 보호도 되고, 멋도 난다.  
...
- [Apple SD 카드 리더](https://www.apple.com/shop/product/MJYT2AM/A/lightning-to-sd-card-camera-reader)(USB-C 아이폰이면 아무 SD 리더나 가능)를 쓰면 사진을 휴대폰으로 바로 가져올 수 있어서 노트북이 필요 없다.  
...
- 해커 기질이 있다면 Apple Photos용 [osxphotos](https://rhettbull.github.io/osxphotos/index.html)라는 멋진 툴도 써 봐.
