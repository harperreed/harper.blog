...
This theme is a very light approximation of the designs of [bear blog](https://bearblog.dev/), [write.as](https://write.as/), and other super minimal writing platforms that I have been admiring for years. I love the simplicity and the focus on the content. I am nothing without my content. ;)

I started with the simple [bearcub](https://github.com/clente/hugo-bearcub/tree/main) hugo theme from [@clente](https://github.com/clente), and tweaked and tweaked. After replacing, and fucking with almost every file in the theme, I eventually got to a place I was happy with. It is familiar enough to my inspiration, but ended up different enough that I think it is close to my own. Regardless, it fits my needs perfectly.

## Now we can begin

I do this every few years. The last time, I think, was 2017. I'm unsure exactly. I tried to peep my [change log](/colophon/), but my constant commits of "changed theme" and "updated theme" are not particularly helpful. lol. Good thing I made my [fancy commit message robot](/2024/03/11/use-an-llm-to-automagically-generate-meaningful-git-commit-messages/).
